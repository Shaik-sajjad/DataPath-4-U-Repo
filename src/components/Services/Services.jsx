...
const Services = () => {
  const services = [
    ...
    {
      icon: (
        <svg preserveAspectRatio="none" data-bbox="20.001 48 159.999 104" viewBox="20.001 48 159.999 104" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label="">
          <defs>
            <style>{`svg [data-color="1"] {fill: #FFFFFF;}`}</style>
          </defs>
          <g>
            <path d="M132.846 127.521V71.422c0-12.911 10.58-23.422 23.577-23.422C169.42 48 180 58.51 180 71.422v56.099c0 12.911-10.58 23.422-23.577 23.422-12.997 0-23.577-10.511-23.577-23.422zm-32.61-79.111c-.359 0-.718 0-1.077.02-11.758.518-21.38 9.703-22.388 21.36-.071.807-.1 1.614-.091 2.401.121 8.528-3.403 16.996-9.672 23.252-6.149 6.127-14.493 9.644-22.878 9.644h-.588c-.709 0-1.438.03-2.156.1-11.65 1.026-20.842 10.61-21.361 22.286-.29 6.466 2.017 12.593 6.487 17.265C31.005 149.42 37.053 152 43.551 152c.38 0 .748 0 1.127-.03 11.728-.538 21.332-9.713 22.329-21.34.071-.777.1-1.564.091-2.331-.091-8.568 3.453-17.056 9.711-23.302 6.169-6.147 14.554-9.674 22.987-9.674h.439c.729 0 1.459-.03 2.186-.1 11.659-1.056 20.833-10.65 21.341-22.316.281-6.456-2.035-12.583-6.497-17.235-4.493-4.672-10.532-7.253-17.019-7.253l-.01-.009zM67.099 71.862c0 12.952-10.543 23.452-23.547 23.452s-23.547-10.5-23.547-23.452c0-12.952 10.543-23.452 23.547-23.452s23.547 10.5 23.547 23.452zm9.592 56.666c0-12.931 10.56-23.452 23.545-23.452 12.988 0 23.547 10.52 23.547 23.452s-10.56 23.452-23.547 23.452c-12.985 0-23.545-10.52-23.545-23.452z" fill="#F4F3F4" clipRule="evenodd" fillRule="evenodd" data-color="1"></path>
          </g>
        </svg>
      ),
      title: 'AI-Powered Insights & Optimization',
      description: 'Predict Analyze Improve Scale'
    },
    {
      icon: (
        <svg preserveAspectRatio="none" data-bbox="20.001 48 159.999 104" viewBox="20.001 48 159.999 104" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label="">
          ...
          <g>
            <path d="M43.511 152c12.984 0 23.509-10.575 23.509-23.62s-10.524-23.62-23.509-23.62-23.51 10.575-23.51 23.62S30.527 152 43.511 152z" fill="#F4F3F4" data-color="1"></path>
            <path d="M156.489 95.24c12.984 0 23.51-10.575 23.51-23.62 0-13.045-10.526-23.62-23.51-23.62S132.98 58.575 132.98 71.62c0 13.045 10.525 23.62 23.509 23.62z" fill="#F4F3F4" data-color="1"></path>
            <path d="M43.511 95.24H99.82c12.96 0 23.51-10.6 23.51-23.62C123.33 58.6 112.78 48 99.82 48H43.511c-12.96 0-23.51 10.6-23.51 23.62 0 13.02 10.551 23.62 23.51 23.62z" fill="#F4F3F4" data-color="1"></path>
            <path d="M156.491 104.76h-56.308c-12.96 0-23.51 10.6-23.51 23.62S87.223 152 100.182 152h56.308c12.96 0 23.51-10.6 23.51-23.62s-10.55-23.62-23.509-23.62z" fill="#F4F3F4" data-color="1"></path>
          </g>
        </svg>
      ),
      title: 'Data Workflow & Reporting Automation',
      description: 'Data Made Automatic'
    },
    {
      icon: (
        <svg preserveAspectRatio="none" data-bbox="20.011 47.995 160 104" viewBox="20.011 47.995 160 104" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label="">
          <defs>
            <style>{`svg [data-color="1"] {fill: #FFFFFF;}`}</style>
          </defs>
          <g>
            <path d="M99.766 94.92c12.984 0 23.544-10.522 23.544-23.452 0-12.932-10.569-23.463-23.544-23.463s-23.544 10.52-23.544 23.452c0 12.932 10.559 23.452 23.544 23.452v.011z" fill="#F4F3F4" data-color="1"></path>
            <path d="M99.773 151.587c.359 0 .717 0 1.078-.021 11.756-.517 21.378-9.702 22.386-21.359.07-.807.1-1.614.089-2.401-.12-8.529 3.403-16.997 9.672-23.252 6.148-6.127 14.492-9.644 22.875-9.644h.589c.708 0 1.436-.03 2.156-.1 11.667-1.037 20.85-10.62 21.369-22.287.289-6.464-2.016-12.592-6.488-17.264-4.492-4.683-10.539-7.264-17.036-7.264-.378 0-.748 0-1.128.03-11.728.538-21.328 9.713-22.327 21.339-.07.778-.098 1.566-.089 2.332.089 8.568-3.453 17.055-9.711 23.302-6.167 6.147-14.552 9.674-22.986 9.674h-.439c-.728 0-1.456.03-2.186.1-11.656 1.056-20.828 10.65-21.337 22.315-.28 6.457 2.034 12.583 6.497 17.235 4.49 4.672 10.528 7.253 17.017 7.253v.012z" fill="#F4F3F4" data-color="1"></path>
            <path d="M67.158 128.573v-56.1c0-12.91-10.578-23.422-23.573-23.422S20.011 59.562 20.011 72.473v56.1c0 12.91 10.58 23.422 23.575 23.422s23.572-10.511 23.572-23.422z" fill="#F4F3F4" data-color="1"></path>
          </g>
        </svg>
      ),
      title: 'Custom Website Enhancement & SEO Optimization',
      description: 'Growth-Ready Websites'
    }
  ]
  ...
  const secondRowLogos = [
    {
      type: 'image',
      src: 'https://static.wixstatic.com/media/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png/v1/fill/w_135,h_117,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png',
      srcset: 'https://static.wixstatic.com/media/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png/v1/fill/w_135,h_117,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png 1x, https://static.wixstatic.com/media/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png/v1/fill/w_270,h_234,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/033c11_cfb36c5a56894646a076e140ce9d1386~mv2.png 2x',
      width: 149,
      height: 80
    },
    {
    ...
    <section id="services" className="services">
        <div className="services-header-content">
            <h2 className="services-title">
                <span className="services-header-text">How we Help</span>
            </h2>
        </div>
                    ...
                    <div key={index} className="service-column">
                      ...
                      <div className='service-content-wrapper'>
                        <h3 className="service-title">
                            <span className="color_11">{service.title}</span>
                        </h3>
                        <p className="service-description">
                            <span className={index === 1 ? "color_36" : "color_11"}>{service.description}</span>
                        </p>
                      </div>
                    </div>
                ))}
